...
import { Home, Users, Calendar, MessageSquare, LogOut, Shield, DollarSign, Settings, Briefcase } from 'lucide-react';
...
const Layout = ({ children, currentTab, setCurrentTab, user, onLogout }) => {
  ...
  const menuItems = [
    ...
    { id: 'properties', label: 'Meus Imóveis (Beta)', icon: <Briefcase size={18} /> },
